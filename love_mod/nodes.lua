...
minetest.register_node("love_mod:heart_wall", {
	description = "Love Mod Wall Heart",
    tiles = {"love_mod_heart.png"},
	drawtype = "nodebox",
	paramtype = "light",
	paramtype2 = "facedir",
...
minetest.register_node("love_mod:sapling", {
	description = "Love Mod Love Tree Sapling",
	drawtype = "plantlike",
	visual_scale = 1.5,
...
minetest.register_node("love_mod:heart_food", {
	description = "Love Mod Yummy Heart",
	drawtype = "plantlike",
	visual_scale = 1.0,
...
minetest.register_node("love_mod:jungleleaves", {
	description = "Love Mod Jungle Leaves",
	drawtype = "allfaces_optional",
	visual_scale = 1.3,
...
minetest.register_node("love_mod:glass", {
	description = "Love Mod Love Glass",
...
minetest.register_node("love_mod:tree_heart", {
	description = "Love Mod Tree With Heart",
...
minetest.register_node("love_mod:wood", {
	description = "Love Mod Wooden Planks",
...
minetest.register_node("love_mod:wood_heart", {
	description = "Love Mod Wooden Heart Planks",
